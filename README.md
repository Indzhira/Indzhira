...
Фокус: прогнозные модели, работа с промышленными данными, интерпретируемость, пайплайны обработки данных.

## Образование
* Яндекс Практикум, Специалист по Data Science, 2026
